...
# Import car make detection functions if available
try:
    from app.car_make.classifier import Classifier
...
if CAR_CLASSIFIER_AVAILABLE:
    ...
    car_classifier = None
    logger.warning("Car make classifier not available")
